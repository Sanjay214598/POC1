...
import com.example.api.CounterPartyController;
...
public class CordaPlugin  extends CordaPluginRegistry {
    /**
     * A list of classes that expose web APIs.
     */
    private final List<Function<CordaRPCOps, ?>> webApis = ImmutableList.of(CounterPartyController::new);
    ...
    private final Map<String, Set<String>> requiredFlows = ImmutableMap.of(
            AgreementFlow.Initiator.class.getName(),
            ImmutableSet.of(
                    AgreementState.class.getName(),
                    Party.class.getName()
            ));
     ...
     */
    private final List<Function<PluginServiceHub, ?>> servicePlugins = ImmutableList.of(AgreementService::new);
