    ...
    public static void main(String[] args) {
        ...
        driver(
                ...
                dsl -> {
                    ...
                    try {
                        NodeHandle counterPartyA = dsl.startNode("CounterPartyA", emptySet(), ImmutableList.of(user), VerifierType.InMemory, emptyMap()).get();
                        NodeHandle counterPartyB = dsl.startNode("CounterPartyB", emptySet(), ImmutableList.of(user), VerifierType.InMemory, emptyMap()).get();
                        NodeHandle counterPartyC = dsl.startNode("CounterPartyC", emptySet(), ImmutableList.of(user), VerifierType.InMemory, emptyMap()).get();

                        dsl.startWebserver(counterPartyA);
                        dsl.startWebserver(counterPartyB);
                        dsl.startWebserver(counterPartyC);
